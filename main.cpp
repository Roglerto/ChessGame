...
_cube *          obj_cube = NULL ;           // objeto indice 5
...
{
longi_cam = longc; // ángulo de longitud actual de la cámara, en grados
lati_cam = latc ; // ángulo de latitud actual de la cámara, en grados
}

void getCamara(float *longc, float *latc){   //DUDA
...
void DibujarObjetoActual()
{
   switch( i_objeto_act )
   {
      ...
      case 4:
         ...
         break;
      case 5:
    	 obj_cube->draw_cube( modo_dibujo_actual );
    	 break;
      default:
...
void Inicializa( int argc, char *argv[] )
{
   ...
   obj_tablero = new tablero(obj_lata_coca_cola,obj_tetera);
...
int main( int argc, char *argv[] )
{
   ...
   glutCreateWindow("IG 12-13 : practica 5");
